...
CalendarEvent _calendarEventDeserialize(
  ...
  final object = CalendarEvent(
    ...
    colorHex: reader.readString(offsets[1]),
    ...
    recurrence: reader.readStringOrNull(offsets[6]) ?? 'none',
...
extension CalendarEventQueryWhereSort
  ...
  QueryBuilder<CalendarEvent, CalendarEvent, QAfterWhere> anyEndTime() {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
...
extension CalendarEventQueryWhere
  ...
  QueryBuilder<CalendarEvent, CalendarEvent, QAfterWhereClause> endTimeEqualTo(
      DateTime endTime) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
        indexName: r'endTime',
  ...
  QueryBuilder<CalendarEvent, CalendarEvent, QAfterWhereClause> endTimeLessThan(
    DateTime endTime, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<CalendarEvent, CalendarEvent, QAfterWhereClause> endTimeBetween(
  ...
  QueryBuilder<CalendarEvent, CalendarEvent, QAfterWhereClause> categoryEqualTo(
      String category) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
...
extension CalendarEventQuerySortBy
  ...
  QueryBuilder<CalendarEvent, CalendarEvent, QAfterSortBy> sortByCategory() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<CalendarEvent, CalendarEvent, QAfterSortBy> sortByColorHex() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<CalendarEvent, CalendarEvent, QAfterSortBy> sortByIsSynced() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<CalendarEvent, CalendarEvent, QAfterSortBy> sortByRecurrence() {
    return QueryBuilder.apply(this, (query) {
...
extension CalendarEventQuerySortThenBy
  ...
  QueryBuilder<CalendarEvent, CalendarEvent, QAfterSortBy> thenByCategory() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'category', Sort.asc);
    });
  }
  ...
  QueryBuilder<CalendarEvent, CalendarEvent, QAfterSortBy> thenByColorHex() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'colorHex', Sort.asc);
    });
  }
  ...
  QueryBuilder<CalendarEvent, CalendarEvent, QAfterSortBy> thenByIsSynced() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isSynced', Sort.asc);
    });
  }
  ...
  QueryBuilder<CalendarEvent, CalendarEvent, QAfterSortBy> thenByRecurrence() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'recurrence', Sort.asc);
    });
  }
...
extension CalendarEventQueryWhereDistinct
  ...
  QueryBuilder<CalendarEvent, CalendarEvent, QDistinct> distinctByCategory(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<CalendarEvent, CalendarEvent, QDistinct> distinctByColorHex(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<CalendarEvent, CalendarEvent, QDistinct> distinctByIsSynced() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'isSynced');
    });
  }

  QueryBuilder<CalendarEvent, CalendarEvent, QDistinct> distinctByRecurrence(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension CalendarEventQueryProperty
  ...
  QueryBuilder<CalendarEvent, String, QQueryOperations> categoryProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'category');
    });
  }

  QueryBuilder<CalendarEvent, String, QQueryOperations> colorHexProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<CalendarEvent, bool, QQueryOperations> isSyncedProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'isSynced');
    });
  }

  QueryBuilder<CalendarEvent, String, QQueryOperations> recurrenceProperty() {
    return QueryBuilder.apply(this, (query) {
